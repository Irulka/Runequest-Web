...
function initAnimales() {
    ...
    const animalesLista = [
        ...
        { nombre: "Hormiga León Gigante", archivo: "js/secciones/bestiario/animales/hormiga.json" }, 
        { nombre: "Escarbajo Jamón", archivo: "js/secciones/bestiario/animales/escarabajo.json" },  
        { nombre: "Escarbajo Guardian", archivo: "js/secciones/bestiario/animales/guardian.json" }, 
        { nombre: "Cienpiés Gigante", archivo: "js/secciones/bestiario/animales/cienpies.json" }, 
        { nombre: "Libélula Gigante", archivo: "js/secciones/bestiario/animales/libelula.json" }, 
        { nombre: "Abeja Gigante", archivo: "js/secciones/bestiario/animales/abeja.json" }, 
        { nombre: "Abeja Reina Gigante", archivo: "js/secciones/bestiario/animales/abejareina.json" },  
        { nombre: "Mantis Gigante", archivo: "js/secciones/bestiario/animales/mantis.json" },    
        { nombre: "Arácnido Gigante", archivo: "js/secciones/bestiario/animales/sopulgido.json" },  
        { nombre: "Araña Lobo", archivo: "js/secciones/bestiario/animales/aralobo.json" },   
        { nombre: "Aráña Lobo Gigante", archivo: "js/secciones/bestiario/animales/aralobogi.json" },  
        { nombre: "Tarántula Gigante", archivo: "js/secciones/bestiario/animales/tarantula.json" },                                                       
        { nombre: "Cangrejo Arboreo", archivo: "js/secciones/bestiario/animales/arboreo.json" },          
        { nombre: "Cangrejo Gigante", archivo: "js/secciones/bestiario/animales/cangrejo.json" },     
        { nombre: "Araña Tejedora", archivo: "js/secciones/bestiario/animales/tejedora.json" },
        { nombre: "Araña Tejedora Gigante", archivo: "js/secciones/bestiario/animales/tejedoragrande.json" },    
        { nombre: "Avispa Gigante", archivo: "js/secciones/bestiario/animales/avispa.json" },    
        { nombre: "Gusano de Hielo Gigante", archivo: "js/secciones/bestiario/animales/gusano.json" },                                                  
